...
## Componenti di Feature Flags

### DashboardPage

Il componente `DashboardPage` utilizza i feature flags per mostrare o nascondere condizionalmente un elemento UI basato sul flag 'nuovaDashboard'.

**Percorso**: `/app/[lang]/(main)/dashboard/page.tsx`

**Funzionalità**:
- Verifica se la feature 'nuovaDashboard' è abilitata
- Mostra condizionalmente una nuova sezione della dashboard
